...
export type RecentlyUpdatedProductsQuery = { products: { edges: Array<{ node: (
        ...
        & { featuredImage?: AdminTypes.Maybe<Pick<AdminTypes.Image, 'id' | 'altText'>>, variants: { edges: Array<{ node: (

...
export type RecentlyUpdatedProductsQuery = { products: { edges: Array<{ node: (
        Pick<AdminTypes.Product, 'id' | 'handle' | 'title' | 'descriptionHtml' | 'tags' | 'vendor' | 'onlineStoreUrl' | 'onlineStorePreviewUrl' | 'hasOnlyDefaultVariant' | 'publishedAt' | 'status' | 'updatedAt' | 'productType' | 'totalInventory'>
        & { featuredMedia?: AdminTypes.Maybe<(
          ...
          & { preview?: AdminTypes.Maybe<{ image?: AdminTypes.Maybe<Pick<AdminTypes.Image, 'altText' | 'url'>> }> }
              ...
              & { inventoryItem: (
                Pick<AdminTypes.InventoryItem, 'id' | 'requiresShipping'>
...
export type InventoryBulkToggleActivationMutationVariables = AdminTypes.Exact<{
  inventoryItemId: AdminTypes.Scalars['ID']['input'];
  inventoryItemUpdates: Array<AdminTypes.InventoryBulkToggleActivationInput> | AdminTypes.InventoryBulkToggleActivationInput;
}>;


export type InventoryBulkToggleActivationMutation = { inventoryBulkToggleActivation?: AdminTypes.Maybe<{ inventoryItem?: AdminTypes.Maybe<Pick<AdminTypes.InventoryItem, 'id'>>, userErrors: Array<Pick<AdminTypes.InventoryBulkToggleActivationUserError, 'field' | 'message' | 'code'>> }> };
...
export type ProductPushMutation = { productSet?: AdminTypes.Maybe<{ product?: AdminTypes.Maybe<(
      ...
      & { media: { nodes: Array<Pick<AdminTypes.ExternalVideo, 'id' | 'status' | 'alt'> | Pick<AdminTypes.MediaImage, 'id' | 'status' | 'alt'> | Pick<AdminTypes.Model3d, 'id' | 'status' | 'alt'> | Pick<AdminTypes.Video, 'id' | 'status' | 'alt'>> } }
